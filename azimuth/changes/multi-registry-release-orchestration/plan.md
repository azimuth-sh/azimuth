# Plan: multi-registry-release-orchestration

- [x] Add release-orchestration intent, design and verification obligations.
- [x] Separate the ordinary root gate from release-only multi-platform qualification.
- [x] Build and retain package, native-binary and image candidates in independent lanes.
