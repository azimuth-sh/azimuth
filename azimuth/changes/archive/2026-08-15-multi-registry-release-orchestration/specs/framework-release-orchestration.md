# Intent delta: framework/release-orchestration
...
### Add scenario: ordinary-ci-excludes-release-only-matrix
...
### Add scenario: selected-lanes-are-independent
...
### Add scenario: complete-account-needs-every-lane
...
### Add scenario: tag-catalog-and-revision-agree
...
### Add scenario: retained-downloads-have-checksums
...
### Add scenario: executable-subjects-have-provenance
...
### Add scenario: packed-packages-install
...
### Add scenario: native-binaries-run
...
### Add scenario: selected-image-platforms-start
...
### Add scenario: completion-needs-public-retrieval
