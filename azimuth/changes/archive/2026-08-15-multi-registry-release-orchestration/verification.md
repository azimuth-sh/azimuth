# Verification delta: framework/release-orchestration

## Add claim: ordinary-ci-excludes-release-only-matrix
Scope: e2e
...
## Add claim: selected-lanes-are-independent
Scope: component
Quantification: universal
Oracle: direct
...
## Add claim: complete-account-needs-every-lane
Scope: component
Quantification: universal
Oracle: direct
...
## Add claim: tag-catalog-and-revision-agree
Scope: component
Quantification: universal
Oracle: direct
...
## Add claim: retained-downloads-have-checksums
Scope: component
Quantification: universal
Oracle: direct
...
## Add claim: executable-subjects-have-provenance
Scope: e2e
Quantification: universal
Oracle: direct
...
## Add claim: packed-packages-install
Scope: component
Quantification: universal
Oracle: direct
...
## Add claim: selected-image-platforms-start
Scope: e2e
Quantification: universal
Oracle: direct
...
## Add claim: exact-existing-target-is-preserved
Scope: component
Quantification: universal
Oracle: direct
...
## Add claim: absent-target-is-selected
Scope: component
Quantification: universal
Oracle: direct
...
## Add claim: conflicting-target-fails
Scope: component
Quantification: universal
Oracle: direct
