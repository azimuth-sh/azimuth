...
## Add requirement: first-alpha-contract
...
### Add scenario: one-source-version
...
### Add scenario: registry-identities-match-contract
...
### Add scenario: packed-contents-are-bounded-and-licensed
...
### Add scenario: support-and-platforms-are-explicit
...
### Add scenario: experimental-source-is-not-published
