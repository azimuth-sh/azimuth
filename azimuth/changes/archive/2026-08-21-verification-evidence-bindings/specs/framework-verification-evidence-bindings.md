# Intent delta: framework/verification-evidence-bindings

## Add requirement: checks-bind-through-explicit-edges
Criticality: routine
...
### Add scenario: one-check-binds-several-claims
...
### Add scenario: one-claim-receives-several-checks
...
### Add scenario: implementation-does-not-declare-evidence
...
## Add requirement: qualifications-are-exact-binding-decisions
Criticality: routine
...
### Add scenario: one-qualification-per-binding
...
### Add scenario: semantic-change-expires-qualification
...
### Add scenario: routine-claim-rejects-verification
...
## Add requirement: challenge-plans-resolve-through-traceability
Criticality: routine
...
### Add scenario: selectors-compose-deterministically
...
### Add scenario: empty-selection-fails-closed
...
### Add scenario: several-sites-compose-one-check
...
### Add scenario: ordinary-tests-remain-outside-azimuth
...
### Add scenario: alpha-one-input-fails
