...
## Requirement: adapter-configuration-is-explicit-and-pinned
Criticality: routine
...
### Scenario: executable-resolution-never-searches-path
...
### Scenario: executable-and-resources-match-pinned-content
...
### Scenario: child-environment-is-an-explicit-allowlist
...
### Scenario: configured-content-is-staged-from-one-byte-stream
...
### Scenario: configured-description-drift-fails-closed
...
### Scenario: capability-identity-tracks-semantics
...
### Scenario: check-execution-does-not-require-current-qualification
...
### Scenario: one-adapter-routes-several-capabilities
...
## Requirement: adapter-invocation-is-strict-and-bounded
Criticality: routine
...
### Scenario: process-resources-are-bounded
...
### Scenario: output-streams-cannot-deadlock-each-other
...
### Scenario: transport-status-is-not-a-product-outcome
...
### Scenario: timed-out-execute-is-not-retried-implicitly
...
### Scenario: unavailable-process-tree-containment-fails-before-spawn
...
## Requirement: execute-validates-normalized-run-semantics
Criticality: routine
...
### Scenario: negative-execution-facts-remain-successful-exchanges
...
### Scenario: dual-role-results-remain-separate
...
### Scenario: native-locators-cannot-replace-input-identity
...
### Scenario: import-corrections-require-verified-predecessors
...
## Requirement: capability-classes-and-provider-identities-stay-separate
Criticality: routine
...
### Scenario: one-capability-supports-several-classes
...
### Scenario: model-extraction-is-not-a-run-operation
...
## Requirement: runtime-command-results-have-stable-exit-classes
Criticality: routine
...
### Scenario: honest-negative-facts-exit-zero
