...
GitHub run 31809174051 checked out revision
`4d89c0e369dd3a49b562e4e97dfd39daaf60d43e` and completed the sole
`./scripts/check.sh` step successfully. An implementation that dropped a root or command relation,
or a workflow that bypassed the root gate, would therefore fail before emitting this evidence.

## Claim: experiment-gates-need-no-domain-checkout
Verdict: sound
Fingerprint: f49d7f2b71a30829
Judged: 2026-08-14
Judge: Codex
