...
The endpoints below describe only the isolated alpha 1 version 1 wire. Their resource names do not declare current alpha 4 Checks, Evidence Bindings, Method Qualifications, Applicability Decisions, Runs or Observations.
