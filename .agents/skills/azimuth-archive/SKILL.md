...
7. Set the proposal to `Status: accepted and complete` only after the preceding facts hold.
...
receipt. The D42 service wire remains isolated, and no Assurance Service export command exists.
